...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=HP-LAPTOP;Database=HospitalityPRO_Db;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BrowsingDatum>(entity =>
            {
                entity.HasKey(e => e.BrowsingId)
                    .HasName("PK__Browsing__6FAAE202DC9D6263");
            ...
            modelBuilder.Entity<Client>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__Client__A9D105348EF94ABD")
                    .IsUnique();
            ...
            modelBuilder.Entity<ExtraService>(entity =>
            {
                entity.HasKey(e => e.ServicesId)
                    .HasName("PK__Extra_Se__A74BF874D9FC4D6B");
            ...
            modelBuilder.Entity<Notification>(entity =>
            {
                ...
                entity.HasOne(d => d.ReceiverClient)
                    ...
                    .HasConstraintName("FK__Notificat__Recei__06CD04F7");

                entity.HasOne(d => d.Reservation)
                    .WithMany(p => p.Notifications)
                    .HasForeignKey(d => d.ReservationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Notificat__Reser__04E4BC85");
            ...
            modelBuilder.Entity<ReservationService>(entity =>
            {
                ...
                entity.HasOne(d => d.Reservation)
                    ...
                    .HasForeignKey(d => d.ReservationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Reservati__Reser__01142BA1");

                entity.HasOne(d => d.Services)
                    .WithMany(p => p.ReservationServices)
                    .HasForeignKey(d => d.ServicesId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Reservati__Servi__02084FDA");
            });

            modelBuilder.Entity<Room>(entity =>
            {
                entity.HasKey(e => e.RoomNumber)
                    .HasName("PK__Room__353A906EA7BC55D0");
                ...
                entity.HasOne(d => d.Hotel)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Room__Hotel_Id__778AC167");

                entity.HasOne(d => d.Type)
                    .WithMany(p => p.Rooms)
                    .HasForeignKey(d => d.TypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Room__Type_Id__787EE5A0");
            });

            modelBuilder.Entity<RoomType>(entity =>
            {
                entity.HasKey(e => e.TypeId)
                    .HasName("PK__Room_Typ__FE90DD9E422AE80D");
